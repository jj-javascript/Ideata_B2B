---
name: audit-a11y
description: Accessibility audit — WCAG 2.1 AA compliance, ARIA, keyboard navigation, semantic HTML. Sonnet works well.
---
...
## Recommended Model
⚡ **Claude Sonnet** — fast and thorough for component-level a11y
